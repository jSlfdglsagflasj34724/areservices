...
<html lang="en">
   ...
   <body class="bg-[#24337a]">
        <div class="flex h-screen items-center">

            <div class="max-w-7xl mx-auto w-full">
               <div class="-mx-4 flex flex-wrap items-center">
                  <div class="w-full px-4 lg:w-7/12">
                     <div class="wow fadeInUp mb-12 lg:mb-0 lg:max-w-[570px]" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s;">
                        <span class="mb-5 block text-lg font-medium leading-tight text-white  sm:text-[22px] xl:text-[22px]">
                        Ready to Use Are Services.
                        </span>
                        <h1 class="mb-6 text-3xl font-bold leading-tight text-white  sm:text-[40px] md:text-[50px] lg:text-[42px] xl:text-[50px]">
                           ARE Services are a locally owned and operated company, providing professional, qualified work .
                        </h1>
                        <p class="mb-10 max-w-[475px] text-gray-300 text-base leading-relaxed text-body">
                           Engineers at your service.
                           We take care of your needs 24/7.
                        </p>
                  ...
                  <div class="w-full px-4 lg:w-5/12">
                     <div class="wow fadeInUp relative z-10 mx-auto w-full max-w-[530px] pt-8 lg:mr-0" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s;">
                        <img src="/images/Frame-1000004191.png" alt="hero image" class="mx-auto max-w-full">
        ...
        <div class="absolute bottom-5 w-full text-center text-gray-300 text-sm font-normal">
            <p>All copyrights reserved ARE Services Ltd</p>
        </div>
   </body>
</html>